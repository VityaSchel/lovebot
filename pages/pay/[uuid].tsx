        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              1 рублей за получение пробного доступа. В дальнейшем, через 6 часов после получения пробного доступа,
              списывается 1990 рублей за каждый месяц использования сервиса. В случае нехватки средств, мы переведем
              вас на тариф со списаниями по 1090 руб каждые две недели, по 590 руб каждую неделю и 190 руб за каждые
              сутки.
            </Checkbox>}
            <div>
              <Button
