        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              13 рублей за получение пробного журнала. В дальнейшем, <b>через 6 часов после получения пробного журнала,
              списывается 1490 рублей за каждый месяц использования сервиса</b>. В случае нехватки средств, мы переведем
              вас на тариф со списаниями по <b>790 руб каждые две недели, по 490 руб каждую неделю и 190 руб за каждые
              сутки</b>.
            </Checkbox>}
            <div>
              <Button
