        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              списывается 1490 рублей за каждый месяц использования сервиса. В случае нехватки средств, мы переведем
              вас на тариф со списаниями по 890 руб каждые две недели, по 490 руб каждую неделю и 190 руб за каждые
              сутки.
            </Checkbox>}
            <div>
              <Button
